...
const SurveyCreation = () => {
  ...
  const handleAddSurvey = (event) => {
    ...
    const likeDislike = form.likeDislike.value;
    ...
    return (
       ...
       <div className="bg-white p-8 rounded-lg shadow-lg max-w-md w-full">
         <h1 className="text-3xl font-bold mb-4 text-center">Create a Survey</h1>
         <form onSubmit={handleAddSurvey}>
           ...
           <div className="mb-4">
              <label className="block text-sm font-medium text-gray-600">Options (Yes or No)</label>
